 ...
 * Custom blocks
 */
//% weight=100 color=#FF10A0 icon="\uf1e6"
//% groups=['Prog. Empfängerschwein', 'Prog. Fernsteuerung']
//% block=Smartsau
namespace switchPig {
    /**
    ...
    export function programReceiver(rfGroupID: MyEnumGroupIDs): void {
        basic.showLeds(`
        # # # # #
        # . . . #
        # . . . #
    ...
    export function switchPlug(ch: MyEnumPlugLabel, state: MyEnumState): void {
        // Add code 
    ...
    //% group="Prog. Fernsteuerung"
    export function selectRfGroupID(rfGroupID: MyEnumGroupIDs): void {
        radio.setGroup(rfGroupID);
    }
}